...
print("Connected to database: UNdata.db")
...
with con:
    ...
    cur.execute("CREATE TABLE gdp (country_name text, _1999 text, _2000 text, \
                _2001 text, _2002 text, _2003 text, _2004 text, _2005 text, \
                _2006 text, _2007 text, _2008 text, _2009 text, _2010 text)"
                )
...
# Converting GDP to log.  As regular number the fit was even worse
